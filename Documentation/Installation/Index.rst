...
install `form2salesforce` still over the ExtensionManager:
...
4.  Install `form2salesforce`
    ...
    Use the search field to find `form2salesforce`. Choose
    the `form2salesforce` line from the search result and click on
    the cloud icon to install `form2salesforce`.

Next step
=========

:ref:`Configure form2salesforce <configuration>`.
